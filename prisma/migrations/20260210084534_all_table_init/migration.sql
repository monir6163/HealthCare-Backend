...
CREATE TABLE "doctor_shedule" (
    ...
    CONSTRAINT "doctor_shedule_pkey" PRIMARY KEY ("doctorId","sheduleId")
);
...
-- CreateIndex
CREATE INDEX "idx_doctor_shedule_doctor_id" ON "doctor_shedule"("doctorId");

-- CreateIndex
CREATE INDEX "idx_doctor_shedule_shedule_id" ON "doctor_shedule"("sheduleId");
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_sheduleId_fkey" FOREIGN KEY ("sheduleId") REFERENCES "shedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "doctor_shedule" ADD CONSTRAINT "doctor_shedule_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "doctor"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "doctor_shedule" ADD CONSTRAINT "doctor_shedule_sheduleId_fkey" FOREIGN KEY ("sheduleId") REFERENCES "shedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
